...
from layers.Transformer_EncDec import Encoder_ori, EncoderLayer, LinearEncoder_abla_design
...
class Model(nn.Module):
    def __init__(self, configs):
        ...
        self.encoder = Encoder_ori(
            [
                LinearEncoder_abla_design(
                    d_model=configs.d_model, d_ff=configs.d_ff, CovMat=self.channel_corr_mat,
                    dropout=configs.dropout, activation=configs.activation, token_num=self.enc_in,
                    CovMatTrans='softmax', WeightTrans='none', NormSet='none', onlyconv=True,
