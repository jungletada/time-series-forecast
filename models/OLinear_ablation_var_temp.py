...
from layers.Transformer_EncDec import Encoder_ori, LinearEncoder_ablation, EncoderLayer
from layers.SelfAttention_Family import AttentionLayer, EnhancedAttention, FullAttention_ablation
            ...
            self.encoder = Encoder_ori(
                [
                    LinearEncoder_ablation(
                        ...
                        var_linear_mode=configs.var_linear_mode, temp_linear=configs.temp_linear,
                        temp_attn_linear=configs.temp_attn_linear, var_linear_enable=configs.var_linear_enable,
                    ) for _ in range(configs.e_layers)
                ],
                norm_layer=nn.LayerNorm(configs.d_model),
                one_output=True,
