...
from layers.Transformer_EncDec import Encoder_ori, EncoderLayer, LinearEncoder_abla_design_nocorr
        ...
        self.encoder = Encoder_ori(
            [
                LinearEncoder_abla_design_nocorr(
                    ...
                    WeightTrans=configs.WeightTrans, NormSet=configs.NormSet
